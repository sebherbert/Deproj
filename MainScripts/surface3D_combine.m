...
7) Finding junction sides and mesh faces connections
8) Finding cell contour and mesh faces connections
...
PARAMS.deployJunctNet = false; % Deploy the simplified network of junctions in addition 
                               % to the smooth contours
%%%%%%%%%%%%%%%%%%%%%% END OF PARAMETERS %%%%%%%%%%%%%%%%%%%%%% 
...
%% finding junctions sides and faces connections
